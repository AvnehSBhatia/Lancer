...
from apollo.paths import (
    ...
    PERSPECTIVE_STAGES_PT,
)

if TYPE_CHECKING:
    import torch.nn as nn

MODEL_PATH = PERSPECTIVE_STAGES_PT
...
def _load_entity():
    from apollo.entity_minilm_converter import load_converter
    return load_converter(ENTITY_DIR)


def _load_context():
    from apollo.context_minilm_converter import load_converter
    return load_converter(CONTEXT_DIR)


def _load_personality():
    from apollo.personality_minilm_converter import load_converter
